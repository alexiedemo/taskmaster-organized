      ...
      <div className="max-w-7xl mx-auto p-3 md:p-4 relative z-10">
        ...
        <Tabs defaultValue="tasks" className="w-full">
          <TabsList className="grid w-full grid-cols-4 bg-white/80 backdrop-blur-md border border-gray-200/50 shadow-lg rounded-2xl p-1.5">
            <TabsTrigger 
              value="tasks" 
              className="flex items-center justify-center gap-1 md:gap-2 rounded-xl py-4 md:py-5 px-1 md:px-4 text-xs md:text-sm font-medium transition-all duration-200 data-[state=active]:bg-gray-900 data-[state=active]:text-white data-[state=active]:shadow-lg text-gray-600 hover:text-gray-900"
            >
            ...
            <TabsTrigger 
              value="social" 
              className="flex items-center justify-center gap-1 md:gap-2 rounded-xl py-4 md:py-5 px-1 md:px-4 text-xs md:text-sm font-medium transition-all duration-200 data-[state=active]:bg-orange-500 data-[state=active]:text-white data-[state=active]:shadow-lg text-gray-600 hover:text-gray-900"
            >
